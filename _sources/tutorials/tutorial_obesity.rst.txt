...
:func:`create_graph<cuda-hybrid.create_graph>` or :func:`generate_model<cuda-hybrid.generate_model>`.
...
At the end the simulation is run using :func:`run_serial<cuda-hybrid.run_serial>`:
